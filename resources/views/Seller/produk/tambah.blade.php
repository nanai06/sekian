...
<head>
    ...
    <title>Tambah Produk - AYU-NE</title>
...
<body>
    ...
    <div class="seller-page">
        <div class="page-header">
            ...
            <a href="{{ route('seller.dashboard') }}" style="font-size:13px; color:var(--pk); text-decoration:none; font-weight:500; display:flex; align-items:center; gap:4px;">
        ...
        <form action="{{ route('seller.produk.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card">
                ...
                <div class="foto-section">
                    ...
                    <div class="foto-hint">Maks. 9 foto • JPG, PNG, WebP • Maks 2MB per foto. Foto pertama jadi foto utama.</div>
                    @error('foto')<div style="font-size:11px; color:#e74c3c; margin-top:6px;">{{ $message }}</div>@enderror
                </div>
            </div>
                ...
                <div class="field-row">
                    ...
                    <div class="field-right">
                        <input type="text" name="merek" class="field-input"
                            placeholder="Contoh: SKINTIFIC, Wardah" value="{{ old('merek') }}">
                    </div>
                </div>
                <div class="field-row" style="align-items:flex-start;">
                    ...
                    <div class="field-right">
                        <textarea name="deskripsi" class="field-input" rows="4"
                            ...
                            maxlength="3000"
                            oninput="document.getElementById('desk-count').textContent=this.value.length+'/3000'">{{ old('deskripsi') }}</textarea>
                ...
                <div class="chips-wrap">
                    @foreach($categories as $cat)
                        <label class="chip-label">
                            ...
                            <span class="chip {{ old('category_id') == $cat->id ? 'active' : '' }}" id="chip-{{ $cat->id }}">
                                {{ $cat->nama }}
                            </span>
                        </label>
                    @endforeach
            ...
            <div class="card">
                ...
                <div class="kondisi-wrap">
                    <label class="kond-label">
                        <input type="radio" name="kondisi" value="baru"
                            {{ old('kondisi', 'baru') === 'baru' ? 'checked' : '' }}
                            onchange="updateKondisi(this)">
                        <div class="kond-chip {{ old('kondisi', 'baru') === 'baru' ? 'active' : '' }}" id="kond-baru">
                    ...
                    <label class="kond-label">
                        <input type="radio" name="kondisi" value="bekas"
                            ...
                            onchange="updateKondisi(this)">
                        <div class="kond-chip {{ old('kondisi') === 'bekas' ? 'active' : '' }}" id="kond-bekas">
                ...
                <div id="bagian-bekas" style="{{ old('kondisi') === 'bekas' ? '' : 'display:none;' }} border-top:0.5px solid #e8f3de;">
                    <div class="field-row">
                        <div class="field-label">Sisa produk <span class="field-req">*</span></div>
                        <div class="persen-wrap">
                            <span class="persen-val" id="persen-val">{{ old('persen_sisa', 70) }}%</span>
                ...
                <div class="field-row">
                    ...
                    <div class="prefix-wrap">
                        ...
                        <input type="number" name="harga" class="field-input"
                            placeholder="0" min="1000" value="{{ old('harga') }}"
                ...
                <div class="field-row">
                    ...
                    <div class="prefix-wrap">
                        <input type="number" name="berat_gram" class="field-input"
                            placeholder="0" min="1" value="{{ old('berat_gram') }}"
            ...
            <div class="btn-row">
                <a href="{{ route('seller.dashboard') }}" class="btn-batal">Batal</a>
    ...
    <script>
        ...
        function previewFoto(input) {
            ...
            grid.querySelectorAll('.foto-preview-item').forEach(el => el.remove());
            Array.from(input.files).forEach(function(file, i) {
                const reader = new FileReader();
                reader.onload = function(e) {
                    const item = document.createElement('div');
                    item.className = 'foto-preview-item';
                    item.innerHTML = `<img src="${e.target.result}" alt="foto ${i+1}"><button type="button" class="hapus-foto">×</button>`;
