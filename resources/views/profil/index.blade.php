...
<head>
    ...
    <style>
        * { margin:0; padding:0; box-sizing:border-box; font-family:'Poppins',sans-serif; }
        body { background: linear-gradient(180deg, #ffe8ed 0%, #eaa5cc70 50%, #ffe8ed 100%); color: #3b1a1a; }
...
<body>
    ...
    <div class="profil-page">
        ...
        <div class="jual-banner-left">
            <div class="jual-banner-icon" style="color: #639922;">
            <iconify-icon icon="solar:shop-bold" width="30" height="30"></iconify-icon>
        </div>
            <div>
                <div class="jual-banner-title">{{ $user->sellerProfile->store->nama_toko ?? 'Toko Saya' }}</div>
                <div class="jual-banner-sub" style="color: #3a5c0f;">Kelola produk, pesanan & toko kamu di sini</div>
            </div>
        </div>
        <a href="{{ route('seller.dashboard') }}" class="btn-mulai-jual" style="color: #639922;">Toko Saya</a>
    </div>
        @else
        {{-- USER BELUM DAFTAR PENJUAL --}}
